...
exports.book_create_post = function(req, res) {
  ...
  var book = new Book({ //this is with reference to the book schema created
...
exports.book_delete_get = function(req, res, next) {
  async.parallel({
    ...
    res.render('book_delete', {title: 'Delete Book', book: results.book, book_instances: results.book_bookinstance});
  });
};
...
exports.book_delete_post = function(req, res, next) {
  async.parallel({
    ...
    if(results.book_bookinstance>0){
      res.render('book_delete', {title: 'Delete Book', book: results.book, book_instances: results.book_bookinstance});
      return;
    }
    else{
    ...
    var book = new Book(
     { title: req.body.title,
      ...
      if (errors) {
       ...
       Book.findByIdAndUpdate(req.params.id, /*book, {},*/ function updateBook(err, thebook) {
           if (err) {
             return next(err);
           }
